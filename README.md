...
pixi add dirac-grid diraccommon
# for installing globally
pixi global install dirac-grid diraccommon
```
...
It is possible to list all of the versions of `dirac-grid` available on your platform:
...
```
pixi search dirac-grid --channel conda-forge
```
